...
public class PlayerRoster {
	...
	public static void main(String[] args) {
		...
		while (!done) {
		    ...
		    System.out.println("Update player rating");
		    System.out.println("Output player above a rating");
		    ...
		    if (command.contains("q") || command.contains("Q")) {
		    	...
		    	System.out.print("Enter a jersey number: "); int jersey = scnr.nextInt();
		    	int i;
		    	for (i = 0; i < MAX_PLAYERS; i++) {
		    	if (jerseyNums[i] == jersey) { break;
		    	} 
		   	}
		    	System.out.print("Enter new rating for player: "); int rating = scnr.nextInt();
		    	playerRating[i] = rating;
		    	command = scnr.nextLine();
